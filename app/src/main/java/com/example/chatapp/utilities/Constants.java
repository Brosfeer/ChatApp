    ...
    public static HashMap<String, String> getRemoteMsgHeaders() {
        if (remoteMsgHeaders == null) {
            ...
            remoteMsgHeaders.put(
                    ...
                    "key=AAAAymalQQE:APA91bFxmja-ugGhIS2gdkHYh3ZCA7cCvTsiwwT80n7yhne4p406kXggUpryMQIyBJaodxXlRChs_l_F-crsS15iCiCKOnRidyiVVaS92zCiqxo7oWVpaqOWfw9gnlOh9ot8JrLDZ1rp"
            );
            remoteMsgHeaders.put(
